  ...
  override fun inspectTable(schema: String?, table: String, maxFloatDigits: Int): Table {
    ...
    val sql =
      """
        ...
        ,   CASE WHEN c.data_type = 'boolean' THEN TRUE ELSE FALSE END AS is_bool_flag
        ,   CASE WHEN c.data_type = 'date' THEN TRUE ELSE FALSE END AS is_date_flag
        ,   CASE WHEN c.data_type LIKE 'timestamp%' THEN TRUE ELSE FALSE END AS is_datetime_flag
        ,   CASE WHEN c.data_type = 'double precision' THEN TRUE ELSE FALSE END AS is_float_flag
        ,   CASE WHEN c.data_type = 'numeric' THEN TRUE ELSE FALSE END AS is_decimal_flag
        ,   CASE WHEN c.data_type = 'integer' THEN TRUE ELSE FALSE END AS is_int_flag
        ,   CASE WHEN c.data_type = 'text' THEN TRUE ELSE FALSE END AS is_text_flag
